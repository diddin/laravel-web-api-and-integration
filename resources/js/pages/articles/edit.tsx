...
import { type SharedData, type BreadcrumbItem, type Article } from '@/types';
...
export default function ArticleEdit() {
    ...
    // const { data, setData, errors, patch, put } = useForm<Required<ArticleForm>>({
    const { data, setData, errors, patch, put } = useForm({
        title: article.title,
